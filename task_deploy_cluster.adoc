...
[TIP]
If the cluster creation operation is initiated but fails to complete, the ONTAP administrative password you define might not be applied. In this case, contact NetApp technical support for assistance.

// 2023-09-13, ONTAPDOC-1306
// 2023-10-17, adding hyperlink
// 2023-01-26, ONTAPDOC-1609